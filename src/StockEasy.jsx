  ...
  const handleUpdateSeuilSurstock = async (newValue) => {
    try {
      ...
      if (error.message?.includes('network') || error.message?.includes('fetch')) {
        ...
        toast.error('❌ Erreur backend Supabase : la fonction "update_parameter" est absente ou mal configurée', {
          description: 'Vérifiez la fonction RPC "update_parameter" dans la base Supabase.',
          duration: 10000
        });
      } else {
