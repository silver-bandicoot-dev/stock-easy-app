  ...
  const steps = [
    {
      ...
      description: "Installez stockeasy depuis le Shopify App Store en un clic.",
      time: "30 sec",
    },
    {
      number: "2",
      ...
      description: "Autorisez l'accès à vos données. Nous synchronisons automatiquement.",
      time: "2 min",
    },
    {
      number: "3",
      ...
      description: "Définissez vos seuils et canaux de notification.",
      time: "5 min",
    },
    {
      number: "4",
      ...
      description: "Recevez vos premières recommandations sous 24h.",
      time: "Auto",
    },
  ];
  ...
  return (
    <section id="how-it-works" className="landing-section bg-[#FAFAF7]">
      <div className="landing-container">
        ...
        >
          <span className="badge badge-neutral mb-4">Comment ça marche</span>
          <h2 className="text-3xl md:text-4xl font-semibold mb-4">
            Connecté à votre boutique Shopify en 2 min
          </h2>
          <p className="text-[#191919]/60 max-w-lg mx-auto">
            Simple, rapide, efficace. Pas besoin d'être technique.
          </p>
        </motion.div>
